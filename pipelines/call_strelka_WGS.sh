...
configManta.py --bam $i --referenceFasta /media/array/callers_proj/raw_data/$REFERENCE --runDir /media/array/callers_proj/raw_data/${i%%.dedup.bam}/mantawd --callRegions /media/array/callers_proj/raw_data/$CALLINGREGIONS
